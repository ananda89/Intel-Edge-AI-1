...
We will choose a model to use and convert it with the Model Optimizer.
...
```
If you are in the classroom workspace, use the “Open App” button to view the output. If working locally, to see the output on a web based interface, open the link [http://0.0.0.0:3000](http://0.0.0.0:3000/) in a browser.
